...
export default function BottomBar() {
  ...
  return (
    ...
    <nav className="bottom-bar" aria-label="Game HUD">
      ...
      {/*
       * bar-row-info: player chip + location + stats.
       * On desktop:  display:contents — children join the nav's flex row directly.
       * On mobile:   display:flex — becomes the top info row of the 2-row bar.
       */}
      ...
      {/*
       * bar-row-nav: quick-nav buttons + fullscreen + settings.
       * On desktop:  display:contents — same as above.
       * On mobile:   display:flex — becomes the bottom nav row of the 2-row bar.
       */}
      <div className="bar-row-nav">
        <div className="bar-rule" aria-hidden />
